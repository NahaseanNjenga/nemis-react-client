...
import {removeTeacher, retireTeacher} from "../../../../actions/teacherActions"
import TextFieldGroup from "../../../../shared/TextFieldsGroup"
...
class Retire extends React.Component {
    ...
    onSubmit(e) {
        ...
        if (this.isValid()) {
            ...
            const teacher = {
                ...
                date_retired: this.state.date,
                school_upi: token.school_upi,
                timestamp: new Date()
            }
            this.props.retireTeacher(teacher).then(
                (teacher) => {
    ...
    render() {
        ...
        const {errors, isLoading, invalid, date,} = this.state
        if (show) {
            return (
                <Modal isOpen={show} toggle={onClose} size="lg">
                    <ModalHeader toggle={onClose}>Mark Teacher as retired</ModalHeader>
                    <ModalBody>
...
Retire.propTypes = {
    ...
    retireTeacher: PropTypes.func.isRequired,
...
export default connect(null, {retireTeacher, removeTeacher})(Retire)
