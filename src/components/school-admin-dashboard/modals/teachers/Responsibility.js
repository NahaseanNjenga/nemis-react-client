...
const {responsibility,count}=this.props
    return(
        <tr>
            ...
            <td>{responsibility.date_relieved?new Date(responsibility.date_relieved).toDateString():'Still assigned'}</td>
            <td><a className="btn btn-sm btn-primary" onClick={this.props.onEdit} data-id={this.props.responsibility._id} data-name={this.props.responsibility.name} data-date={this.props.responsibility.date_assigned} href="">Edit</a>
                {responsibility.date_relieved?'':<button className="btn btn-sm btn-warning" onClick={this.props.onRelieve} data-id={this.props.responsibility._id} data-name={this.props.responsibility.name} data-date={this.props.responsibility.date_assigned} >Relieve</button>}</td>
        </tr>
    )
    }
}
